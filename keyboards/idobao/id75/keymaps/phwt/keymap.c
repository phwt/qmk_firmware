...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { // clang-format off
    [_CMK] = LAYOUT_ortho_5x15(
        ...
        KC_LCTL, MO(_FN), KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  KC_SPC,  KC_P0,   KC_PPLS, LOWER,   RAISE,   KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_LWR] = LAYOUT_ortho_5x15(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, V_UP,    _______, V_DOWN,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, V_MID,   _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_RSE] = LAYOUT_ortho_5x15(
        ...
        _______, KC_SLSH, KC_BSLS, KC_PLUS, KC_MINS, KC_DQUO, _______, _______, _______, KC_QUOT, KC_UNDS, KC_EQL,  KC_LCBR, KC_RCBR, _______,
        _______, KC_QUES, KC_PIPE, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, _______, _______, _______, _______, _______
    ),
