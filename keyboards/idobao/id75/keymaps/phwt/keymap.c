...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { // clang-format off
    ...
    [_RSE] = LAYOUT_ortho_5x15(
        ...
        _______, KC_SLSH, KC_BSLS, KC_PLUS, KC_MINS, KC_COMM, _______, _______, _______, KC_DQUO, KC_UNDS, KC_MINS, KC_LCBR, KC_RCBR, _______,
        _______, KC_QUES, KC_PIPE, KC_COLN, KC_SCLN, KC_DOT,  _______, _______, _______, KC_QUOT, KC_LABK, KC_RABK, KC_LBRC, KC_RBRC, _______,
