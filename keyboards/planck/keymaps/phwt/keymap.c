...
enum layers {
    _BASE,
    _LOWER,  // Number row and special characters
    _RAISE,  // Function, arrow, and mouse keys
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WINE] = LAYOUT_planck_grid(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        KC_LGUI, _______, KC_LCTL, KC_LALT, _______, _______, _______, _______, _______, _______, _______, _______
    ),
};
/* clang-format on */
