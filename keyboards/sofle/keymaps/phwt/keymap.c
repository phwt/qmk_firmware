...
[_QWERTY] = LAYOUT(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    TH_BSPC,
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,
  TH_BSPC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_MPLY,    XXXXXXX, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  LOWER,        RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
[_COLEMAK] = LAYOUT(
...
[_RAISE] = LAYOUT(
  ...
  KC_TILD, _______, _______, _______, _______, _______,                      _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS,
  KC_CAPS, KC_CIRC, _______, _______, C(KC_F), _______,                      _______, C(KC_J), _______, _______, KC_DLR,  KC_QUOT,
  _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______,
